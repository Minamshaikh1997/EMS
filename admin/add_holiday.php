...
<title>Holiday Management - EMS</title>
...
<div class="main-content" id="mainContent">
    <header class="header">
        <div class="header-left">
            ...
            <h4>Holiday Management <span>/ Manage Holidays</span></h4>
        </div>
    ...
    <div class="page-content">
                ...
                <form method="POST">
                    <div class="row g-3">
                        ...
                        <div class="col-md-2 d-flex align-items-end">
                            <button type="submit" name="save" class="btn btn-success w-100 rounded-pill"><i class="fa fa-save"></i> Save</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="card-modern">
            <div class="card-header-custom">
                <h5><i class="fa fa-plane"></i> All Holidays</h5>
            </div>
            <div class="card-body-custom p-0">
                <div class="table-responsive">
                    <table class="table table-modern">
                        <thead>
                            <tr><th>ID</th><th>Holiday</th><th>Date</th><th>Description</th><th>Action</th></tr>
                        </thead>
                        <tbody>
                        ...
                        <?php if(mysqli_num_rows($result) == 0): ?>
                            <tr><td colspan="5" class="text-center py-4 text-muted">No holidays found</td></tr>
                        <?php endif; ?>
                        </tbody>
                    </table>
                </div>
