...
<div class="main-content" id="mainContent">
    <header class="header">
        <div class="header-left">
            ...
            <h4>Notice Board <span>/ Manage Notices</span></h4>
        </div>
    ...
    <div class="page-content">
                ...
                <form method="POST">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="notice" class="form-control" rows="4" required></textarea>
                        </div>
                        <div class="col-12">
                            <button type="submit" name="save" class="btn btn-success rounded-pill px-4"><i class="fa fa-save"></i> Add Notice</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="card-modern">
            <div class="card-header-custom">
                <h5><i class="fa fa-bullhorn"></i> All Notices</h5>
            </div>
            <div class="card-body-custom p-0">
                <div class="table-responsive">
                    <table class="table table-modern">
                        <thead>
                            <tr><th>ID</th><th>Title</th><th>Notice</th><th>Date</th><th>Action</th></tr>
                        </thead>
                        <tbody>
