...
if (isset($_POST['change_password'])) {
    ...
    if (!password_verify($current_password, $admin['password'])) {
        ...
        $message = "<div class='alert alert-danger alert-dismissible fade show rounded-pill px-4'><i class='fa fa-exclamation-circle me-2'></i> " . htmlspecialchars($passwordError) . "<button type='button' class='btn-close' data-bs-dismiss='alert'></button></div>";
        ...
        ems_audit($conn, 'admin.password_changed', 'admin', (int)($_SESSION['admin_id'] ?? 0));
